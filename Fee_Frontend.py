...
class Fee():
    def __init__(self, master):
        ...
        # ==================================================Entries=================================================
        self.var_1 = DoubleVar(Frame_1, value='98000')
